      ...
      <div className="border-t border-[#2a2a50] pt-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="pixel-panel bg-green-500/10 p-2 text-center">
            <div className="font-display text-xl font-black text-green-400">{operatingRides}</div>
          ...
          <div className="pixel-panel bg-red-500/10 p-2 text-center">
            <div className="font-display text-xl font-black text-red-400">{brokenRides}</div>
          ...
          <div className="pixel-panel bg-yellow-500/10 p-2 text-center">
            <div className="font-display text-xl font-black text-yellow-400">{repairingRides}</div>
