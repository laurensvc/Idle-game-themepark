...
OKLCH is perceptually uniform — equal steps in lightness _look_ equal.
...
60% neutral backgrounds, 30% secondary (text, borders), 10% accent (CTAs, highlights). Accent works _because_ it's rare.
